namespace Microsoft.Dynamics.Integration.Adapters.DynamicCrm
{
    ...
    /// <summary>
    /// This adapter is used to connect to a source Microsoft Dynamics CRM system.
    /// </summary>
    [Adapter]
    public class DynamicCrmAdapterSource : DynamicCrmAdapter
    {
        private const string Version = "2011";
        private const string ObjectConfigFolderName = "ObjectConfig\\DynamicCRMAdapterSource";
        private readonly Guid adapterId = new Guid("93b89c42-91af-49de-a9da-15d3318fb431");
        private System.Collections.ObjectModel.Collection<ObjectProvider> providers;

        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicCrmAdapterSource"/> class.
        /// </summary>
        public DynamicCrmAdapterSource()
        {
            this.DisplayName = Resources.DynamicCRMSourceAdapterDisplayName;
            this.Id = this.adapterId;
            this.Name = Resources.DynamicCRMSourceAdapterName;
        }
        ...
        public override System.Collections.ObjectModel.Collection<ObjectProvider> ObjectReaderProviders
        {
            get
            {
                ...
                this.GetObjectProviders().ForEach(op => readers.Add(op));
                return readers;
            }
        }
