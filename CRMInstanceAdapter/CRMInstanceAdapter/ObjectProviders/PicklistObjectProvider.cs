namespace Microsoft.Dynamics.Integration.Adapters.DynamicCrm.ObjectProviders
{
    ...
    public class PicklistObjectProvider : CrmObjectProvider, IObjectReader, IObjectWriter, IBulkObjectWriter
    {
        ...
        /// <summary>
        /// Creates an instance of the <c>PicklistObjectProvider</c> class for interacting with Dynamics CRM Picklists.
        /// </summary>
        ...
        private void ProcessPickLists(Dictionary<string, object> dictionary, string entityName)
        {
            ...
            foreach (string attributeName in dictionary.Keys)
            {
                ...
                RetrieveAttributeResponse amRes = null;
                try
                {
                    amRes = (RetrieveAttributeResponse)this.CrmAdapter.OrganizationService.Execute(attribReq);
                    if (langRes == null)
                    {
                ...
                if (amRes != null)
                {
                    PicklistAttributeMetadata picklistAttrib = amRes.AttributeMetadata as PicklistAttributeMetadata;
                    ...
                    foreach (string picklistName in values)
                    {
                        try
                        {
                            ...
                            if (option == null)
                            {
                                ...
                                insertRequest.Label = CreateSingleLabel(picklistName, amRes.AttributeMetadata.DisplayName.UserLocalizedLabel.LanguageCode);
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "modifiedDate")]
